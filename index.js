/* ==========================================================================
   Aastha Rajput Portfolio — JS Script (Showcase All Files Version)
   ========================================================================== */
  ...
  mediaWrappers.forEach(wrapper => {
    wrapper.addEventListener('click', () => {
      ...
      if (card) {
        ...
        captionText = `${label} — ${title}`;
      } else {
        // It's a gallery thumb card
        captionText = wrapper.getAttribute('data-title') || (img ? img.alt : 'Creative Showcase');
      }
